...
const doctorCheckCopy: Record<string, string> = {
  ...
  login: "Codex 登录",
  skill: "创作者插件源码",
  "plugin-installation": "Codex 插件关联",
  workspace: "任务工作区",
