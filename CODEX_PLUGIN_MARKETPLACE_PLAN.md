...
> 制定日期：2026-08-17
>
> 当前阶段：M5 公开材料与 HTTPS 页面已完成；仅剩账号侧开发者身份、组织和发布权限检查，完成后才能进入 M6
>
...
| P33 | [x] | 准备官网与支持地址 | 公共 HTTPS 页面 | 用户可访问，包含使用说明和联系方式 |
| P34 | [x] | 准备隐私政策和服务条款 | 公共 HTTPS 页面 | 说明数据处理、文件访问、第三方能力和责任边界 |
...
- 插件分支 `codex/creator-content-studio-plugin` 已推送；GitHub Pages 直接以该分支的 `/docs` 为发布源，不需要提前合并 `main`。
- 官网、支持页、隐私政策和服务条款四个公开 HTTPS 地址均返回 200，页面标题和核心内容已核对，P33/P34 完成。
...
- 当前 Codex CLI 未提供公共市场发布/提交命令；截至 2026-08-20，官方开发者文档中也未检索到公开的 Codex 插件市场提交入口。P36/P38 继续标记为外部依赖，后续以账号实际可见页面或官方邀请流程为准，不虚构提交链路。
